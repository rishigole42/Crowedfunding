                    ...
                    <div class="row">
                        ...
                        <?php foreach($detail as $blog){ ?>
                            ...
                            <div class="col-sm-4" style="">
                                <div class="single-blog mb-30" style="height:450px;">
                                  ...
                                  <div class="blog-text">
        <center>    <h3><a href="#" style="color: #0aaaa0;"><?php echo $blog->blogtital; ?></a></h3></center>                                        <p><?php // echo $blog->blog; ?></p>
                                        <a href="blogdetails.php?id=<?php echo $blog->sno; ?>">Read More...</a>     
                                    </div>
                                </div>
                            </div>
                            <!-- End single blog -->
