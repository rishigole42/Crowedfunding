...
<html class="no-js" lang="en">
    <head>
		...
		<link rel="stylesheet" type="text/css" href="includes/css/timeline.css" >
...
<script src="js\bootstrap.min.js"></script>
    ...
    <body>
        				...
        				<div class="row">
	                            ...
	                            <div class="top-social">
	                                <nav>
	                                	<ul>
		                                    ...
		                                    <li><a href="https://facebook.com/sharer/sharer.php?u=http%3A%2F%2Fsharingbuttons.io"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
		                                    <li><a href="https://twitter.com/intent/tweet/?text=Super%20fast%20and%20easy%20Social%20Media%20Sharing%20Buttons.%20No%20JavaScript.%20No%20tracking.&url=http%3A%2F%2Fsharingbuttons.io"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
		                                    <li><a href="https://plus.google.com/up/?continue=https://plus.google.com/share?url%3Dhttp://sharingbuttons.io"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
	                        ...
	                        <div class="col-sm-7 col-md-6">
	                            <div class="call-to-action">
	                                <nav>
	                                	<ul>
		                                	<li><a href="support@edisha.com"><i class="fa fa-envelope" aria-hidden="true"></i> Email: support@edisha.com</a></li>
		                                	<li><a href="tel:+5881234567"><i class="fa fa-phone" aria-hidden="true"></i> Phone: (+91)1234567890</a></li>
        				...
        				<div class="row">
        					...
        					<div class="col-sm-9 col-xs-12">
        						<div class="main-menu">
        							<nav>
        								<ul>
        									<li><a href="dashboard2.php">Home</a>
       ...
       <li><a href="event.php">Events</a></li>
        									...
        									<li><a href="success_story.php">Success stories</a>
        						...
        						<div class="donate-button ptb-32">
        							<a style="margin:5px;" class="waves-effect waves-light" href="signup.php">Sign UP</a>
        							
        							
        						</div>&nbsp; &nbsp; &nbsp; &nbsp;
   
 <div class="donate-button ptb-32">
        							<a style="margin:5px;" class="waves-effect waves-light" href="login.php">Sign IN</a>
        						</div>  
                                    ...
                                    <ul class="nav">
                                        <li><a class="home" href="#">Home</a>
                                            <ul>
                                                ...
                                                <li><a href="index-non-topbar">Home 5</a></li>
                                                <li><a href="index-non-sticky">Home 6</a></li>
                                            </ul>
                                        </li>
