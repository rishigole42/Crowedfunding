        				...
        				<div class="row">
	                        ...
	                        <div class="col-sm-7 col-md-6">
	                            <div class="call-to-action">
	                                <nav>
	                                	<ul>
		                                	<li><a href="mailto:ourmail@domain.com"><i class="fa fa-envelope" aria-hidden="true"></i> Email:support@edisha.com</a></li>
        				...
        				<div class="row">
        					...
        					<div class="col-sm-9 col-xs-12">
        						...
        						<div class="donate-button ptb-32">
        							<a class="waves-effect waves-light" style="margin:3px;" href="signup.php">Sign UP</a>
        							
        							
        						</div>
   
 <div class="donate-button ptb-32">
        							<a class="waves-effect waves-light" style="margin:3px;" href="signup.php">Sign IN</a>
        						</div>  
