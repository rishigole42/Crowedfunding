...
include("vendor.php");
$id = $_GET['id'];
$Pcontent = $db->select("pdetailconent","*",array("personid"=>$id));	
$detail = $db->select("needypersondetails","*",array("sno"=>$id));
...
<a class="resp-sharing-button__link" href="https://plus.google.com/share?url=http%3A%2F%2Fsharingbuttons.io" target="_blank" rel="noopener" aria-label="Share on Google+">
 ...
 <h3 style="font-variant: petite-caps;
  font-stretch: expanded;
  font-size: 27px;"><?php echo $content->Tital;?></h3>
  <p style="    font-size: 16px;"><?php echo $content->description;?> </p>
                        ...
                        <h5 style="font-weight: 700; float: right;
    margin-right: 27px;
    margin-top: 29px;
    font-size: 23px;
">₹ <?php echo $content->InitialAmount;?></h5> 
                        </div>
                         <div class="col-md-6" style="font-weight: bold;"> 
                        <button style="width: 63%;
    margin-top: 20px;
    padding: 10px; background-color:#41C3AC; border-color:white; float: right;"  class="btn btn-warning btn-lg btn-fullrounded center-block" onclick="myFunction()">			
