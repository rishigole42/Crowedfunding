                                ...
                                <div class="col-sm-4">
                                    <div class="footer-widget widget-one">
                                        ...
                                        <div class="widget-about-content">
                                            <p>E-DISHA is an online crowdfunding platform that enables anyone across India to raise funds for healthcare, education, sports, disaster relief and other personal causes, with great ease.  </p>
                                        </div>
                                        <div class="widget-contact-content">
                                            <h3>CONTACT US</h3>
                                            <a href="(+91)1234567890">Phone :  (+91)1234567890</a>
                                            <a href="mailto:support@edisha.com">Email: support@edisha.com</a>
                                            <p>Address: Hoshangabad Road Bhopal 462023 M.P. INDIA.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- End footer widget -->
                                    ...
                                    <div class="footer-widget widget-two">
                                        ...
                                        <nav>
                                            <ul>
                                                ...
                                                <li><a href="PROJECT FILE.pdf">Projects</a></li>
                                                <li><a href="img/gallery/charity.jpeg">Gallery</a></li>
                ...
                <div class="footer-bottom">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-8">
                                <div class="copyright">
                                    <p>Copyright 2019 All right reserved. Design by <a href="dashboard2.php">E-DISHA</a></p>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="footer-social">
                                    <nav>
                                        <ul>  <img src="accepted.jpg" width="457">
                                            </ul>
                                    </nav>
                                </div>
                            </div>
