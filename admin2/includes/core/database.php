...
class database {
	...
	function delete($table,$para,$where,$AndOrClause = 'AND')
	{
		
				try{
				
				
				$colums = array_keys($para);
				$colums_l = $colums;
	...
	function query($sql,$array,$debug=FALSE)
	{
		try{
			
		
			$statement = $this->db->prepare($sql);
			$bool = $statement->execute($array);
			//varPrint($array);
			$result = array();
